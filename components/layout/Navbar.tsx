    ...
    <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-6">
      ...
      <div className="relative">
        ...
        >
          ...
          <span className="hidden max-w-[160px] truncate text-gray-700 md:block">
            {nombreMostrado}
          </span>
          ...
          <>
            ...
            <div className="absolute right-0 top-full z-20 mt-1 w-48 rounded-lg border border-gray-200 bg-white py-1 shadow-lg">
              <div className="border-b px-4 py-2">
                <p className="truncate text-xs font-medium text-gray-900">{nombreMostrado}</p>
                <p className="truncate text-xs text-gray-500">{perfil.email}</p>
              </div>
              <button
