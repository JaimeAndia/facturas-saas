  ...
  return (
    <>
      ...
      >
        ...
        <h2 className="mt-4 text-center text-lg font-bold text-gray-900">{mensaje.titulo}</h2>
        <p className="mt-2 text-center text-sm text-gray-500">{mensaje.descripcion}</p>
          ...
          <div className="mt-5 rounded-xl border border-blue-100 bg-blue-50 p-4">
            ...
            <ul className="space-y-1.5">
              {configObjetivo.features.map((f) => (
                <li key={f} className="flex items-center gap-2 text-sm text-blue-900">
