  ...
  if (!esPro) {
    return (
      <div className="mx-auto max-w-lg py-16 text-center">
        ...
        <h1 className="text-lg font-bold text-gray-900">Plan Básico o superior requerido</h1>
  ...
  return (
    <div className="space-y-5">
      <div>
        ...
        <h1 className="text-xl font-bold text-gray-900">Nueva factura recurrente</h1>
