  ...
  return (
    <div className="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-gray-700 dark:bg-gray-800">
      <button
        ...
        className="flex w-full items-center justify-between px-5 py-4 text-left hover:bg-gray-50 transition-colors dark:hover:bg-gray-700"
      >
        ...
        <svg
          className={`h-4 w-4 shrink-0 text-gray-400 transition-transform duration-200 dark:text-gray-500 ${abierto ? 'rotate-180' : ''}`}
      ...
      {abierto && (
        <div className="space-y-3 border-t border-gray-100 px-5 py-4 dark:border-gray-700">
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Un <strong className="text-gray-800 dark:text-gray-200">sello de autenticidad</strong> es un registro público e inmutable
            que prueba que este documento existía exactamente en la forma en que lo ves, en la fecha indicada.
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Este registro está almacenado en el <strong className="text-gray-800 dark:text-gray-200">XRP Ledger</strong>, una red
            blockchain descentralizada operada por más de 150 validadores independientes en todo el mundo.
            <strong className="text-gray-800 dark:text-gray-200"> Nadie puede borrarlo ni modificarlo</strong>, ni siquiera FacturX.
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            El <strong className="text-gray-800 dark:text-gray-200">hash SHA-256</strong> es una huella digital matemática del
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400">
            ...
            transacción y número de ledger, que actúa como <strong className="text-gray-800 dark:text-gray-200">sello de tiempo
            irrefutable</strong> reconocido internacionalmente.
          </p>
          <p className="text-sm text-gray-600 dark:text-gray-400">
            Puede ser presentado como <strong className="text-gray-800 dark:text-gray-200">prueba en reclamaciones, disputas
